...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    final public static String HOURLY_DATA = "HOURLY_DATA";
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        hourlyWeatherIntent.putExtra(HOURLY_DATA, mForecast.getHourlyForecast());
                        //User Preference Do-Stuff Begin (Needs to start after mCurrent is Initialized) -- Positioned in Response Block to Achieve this
                        prepareUiData();
                        updateUiElements();
    ...
    private void updateUiElements() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                timeTextView.setText("Refreshed at: " + mCurrent.getFormattedTime());
                ...
                summaryCardView.setCardBackgroundColor(mCurrent.getSummaryCardColor(getApplicationContext()));
    ...
    private void prepareUiData() {
        ...
        if (temperatureFormatPref.equals("0")) {
            temperatureText = mCurrent.getTemperature();
            temperatureText = mCurrent.convertFahrenheitToCelsius(temperatureText);

        } else if (temperatureFormatPref.equals("1")) {
            temperatureText = mCurrent.getTemperature();
        }
        //User Preference Do-Stuff End
        locationText = mCurrent.getTimeZone();
        summaryText = mCurrent.getSummary();
        iconImageId = mCurrent.getIconId();
        humidityText = ((mCurrent.getHumidity() * 100) + "%");
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        forecastURL = "https://api.forecast.io/forecast/" + forecastAPIKey + "/" + latitude + "," + longitude + "?exclude=['minutely','daily','alerts','flags']";
        if (ableToSync) {
